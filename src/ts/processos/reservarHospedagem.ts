...
export default class CadastroHospedagem extends Processo {
    ...
    processar(): void {
        ...
        let documento = this.entrada.receberTexto('Qual o número do seu documento? ')
        ...
        this.opcao = this.entrada.receberNumero('Qual tipo de quarto deseja?')

        switch(this.opcao) {
            case 1: 
                let primeiraAcomodacao = new Acomodacao(
                ...
                this.clientes[index].Acomodacoes = primeiraAcomodacao
                break
            
            case 2:
                let segundaAcomodacao = new Acomodacao(
                ...
                this.clientes[index].Acomodacoes = segundaAcomodacao
                break


            case 3:
                let terceiraAcomodacao = new Acomodacao(
                ...
                this.clientes[index].Acomodacoes = terceiraAcomodacao
                break

            case 4:
                let quartaAcomodacao = new Acomodacao(
                ...
                this.clientes[index].Acomodacoes = quartaAcomodacao
                break

            case 5:
                let quintaAcomodacao = new Acomodacao(
                ...
                this.clientes[index].Acomodacoes = quintaAcomodacao
                break
            
            case 6:
                let sextaAcomodacao = new Acomodacao(
                ...
                this.clientes[index].Acomodacoes = sextaAcomodacao
                break
        } 
    }
}