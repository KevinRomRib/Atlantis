...
export default class EditarClienteTitular extends Processo {
    ...
    processar(): void {
        console.clear()
        console.log('Editando um titular')
        this.numeroDoDocumento = this.entrada.receberNumero('Qual é o número de documento do titular: ')
